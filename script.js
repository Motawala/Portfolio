...
const experienceData = [
    {
        ...
        description: "Developed interactive data visualizations using JointJS to create prototype data models for the Research Department. Built user interfaces with JointJS, HTML, CSS, and JSON-LD to enhance user experience. Processed large datasets (30,000-50,000 records) using Python Pandas for curation, aggregation, and de-duplication. Developed and integrated modules utilizing APIs from Elsevier, OpenAlex, NIH, NSF, USAspending, Scopus and Pure for efficient data retrieval, processing, analysis and upload saving hours of time and effort for Research Office staff. Created Python-based applications with Tkinter and Bootstrap that automated data cleanup and analysis. Implemented machine learning models for pattern recognition to streamline data processing workflows. Led development of an open-source web application (RDAF Tool) that transforms Excel data into interactive visualizations using JSON-LD and JavaScript. Designed and implemented end-to-end data solutions on Azure Cloud, including Azure SQL Database, Azure Data Factory, and Azure Batch, leading ETL pipeline development, batch processing automation, and scalable data integration workflows from development to production."
    },
    {
